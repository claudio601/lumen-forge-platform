...
const iconMap: Record<string, React.ElementType> = {
    ...
    AlignJustify, Siren, PlugZap, ShieldAlert, Sun, Tag, Settings, TestTube,
    Ruler, TrainTrack, UtilityPole,
};
            ...
            {menuOpen && (
                <div className="lg:hidden border-t bg-background animate-fade-in">
                    <div className="container py-4 space-y-1">
                        ...
                        <Link
                            to="/instalacion"
                            className="flex items-center gap-2 py-2 px-3 text-sm font-semibold text-primary hover:bg-accent rounded-md"
                            onClick={() => setMenuOpen(false)}
                        >
