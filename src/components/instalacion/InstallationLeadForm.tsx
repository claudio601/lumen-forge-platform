...
async function sendLeadEmail(payload: InstallationLeadPayload): Promise<void> {
  const asunto =
    'Nueva solicitud de instalación — ' + payload.comuna + ' — ' + payload.tipoProyecto;
...
const InstallationLeadForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus('error');
      setErrorMsg(
        'No pudimos enviar tu solicitud. Por favor escíbenos por WhatsApp o inténtalo de nuevo.'
      );
    }
  };
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        <div className="sm:col-span-2">
          <label htmlFor="ilf-descripcion" className={labelClass}>
            Descripción breve del proyecto <span className="text-red-500">*</span>
          </label>
          <textarea
            id="ilf-descripcion"
            name="descripcion"
            ...
            onChange={handleChange}
            rows={3}
            placeholder="Cuéntanos el espacio, cantidad de puntos de luz aproximados, o cualquier detalle relevante."
        ...
        <div className="sm:col-span-2">
          <label className="flex items-start gap-3 cursor-pointer select-none">
            ...
            <span className="text-sm text-gray-600 leading-snug">
              Acepto que eLIGHTS me contacte para responder a esta solicitud.
