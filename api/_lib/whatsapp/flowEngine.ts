...
// [COPY-v2] Mensaje inicial optimizado para lanzamiento con numero real
export const MSG1 = 'Hola! Soy el asistente de eLIGHTS.cl \ud83d\udc4b\n\nTe puedo ayudar a orientar tu requerimiento de iluminacion y dejar tu solicitud lista para cotizacion.\n\nPara partir, cuentame:\n1) Que producto buscas (ampolletas, focos, paneles, etc.)\n2) Que tipo de luz prefieres (calida, neutra o fria)\n3) Cuantas unidades necesitas aprox.';
