...
// [COPY-v3] Respuesta para solicitudes de contacto directo con ejecutivos
export const MSG_EXECUTIVE = 'Perfecto \ud83d\udc4d\n\nSi prefieres hablar directamente con un ejecutivo, puedes escribirle por correo:\n\n\ud83d\udce9 claudio@elights.cl\n\ud83d\udce9 constanza@elights.cl\n\nDe todas formas, si quieres, tambien puedo ayudarte a dejar tu solicitud lista para cotizacion por aca.';
...
// [COPY-v3] Deteccion de solicitud de ejecutivo por nombre
...
export function processFlowStep(
  ...
  // [COPY-v3] Deteccion de solicitud de ejecutivo por nombre — NO cierra flujo, NO activa wantsHuman
