...
const NEW_REQ_SOLO_PROYECTO_RE =
    /^(quincho|terraza|patio|living|comedor|dormitorio|habitaci[o\u00f3]n|cocina|ba[n\u00f1]o|ba[n\u00f1]os|bodega|oficina|casa|local comercial|local|galp[o\u00f3]n|galpon|faena|tienda|exterior|interior|planta|fabrica|nave industrial|departamento|edificio)[.!?\s]*$/i;
...
function articleFor(proyecto: string): string {
    ...
    const femeninos =
          /^(terraza|oficina|habitaci[o\u00f3]n|cocina|bodega|tienda|sala|fabrica|f[a\u00e1]brica|nave industrial|faena|planta)/;
    const masculinoPlural = /^(ba[n\u00f1]os)/;
