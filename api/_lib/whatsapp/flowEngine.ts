...
// [COPY-v2] Cierre mejorado — refuerza revision humana, tono profesional
export const MSG4 =
...
// [COPY-v2] Handoff mas claro y realista, sin promesas de inmediatez
...
// [COPY-executive] Respuesta para mensajes que mencionan ejecutivos por nombre
export const MSG_EXECUTIVE =
          'Perfecto \uD83D\uDC4D Si prefieres hablar directamente con un ejecutivo, puedes escribirle por correo:\n\uD83D\uDCE9 claudio@elights.cl\n\uD83D\uDCE9 constanza@elights.cl\n\nDe todas formas, si quieres, tambien puedo ayudarte a dejar tu solicitud lista para cotizacion por aca.';
...
const B2B_SIGNAL_RE =
          /empresa|factura|obra|proveedor|licitaci[oó]n|constructora|instalaci[oó]n|bodega|oficina|local comercial|proyecto comercial|s\.a\.|spa|ltda/i;
const PRODUCTO_RE =
...
export function processFlowStep(
  ...
  // [EXECUTIVE-RE] Guard: detectar nombre de ejecutivo ANTES del flujo principal
  // Solo activa si NO hay intencion comercial (ej: "necesito focos" va al flujo normal)
...
// [FIX-ARTICULO] Retorna el articulo definido correcto segun el espacio/proyecto capturado
// Incluye "casa" en femeninos para evitar "para el casa"
